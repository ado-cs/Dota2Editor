        ...
        private static readonly Dictionary<string, Dictionary<string, string>> LANG = new()
        {
            { 
                ...
                { 
                    ...
                    { "EditorPanel.Tip.TextMode", "切换到文本模式" },
                    { "EditorPanel.Tip.Batch", "批量修改" },
            ...
            },
            {
                "en-US", new()
                {
                    ...
                    { "EditorPanel.ListBox.Add", "Record Changes" },
                    ...
                    { "EditorPanel.Tip.TextMode", "Switch to text mode" },
                    { "EditorPanel.Tip.Batch", "Batch modification" },
